  ...
  return (
    <Layout>
      <div className="flex flex-col gap-6">
        ...
        >
          <div>
            <h1 className="font-heading text-4xl font-bold text-primary">Estadisticas de Rendimiento</h1>
            <p className="text-lg text-secondary mt-2 font-medium">Visualiza graficas interactivas sobre la asistencia general.</p>
          </div>
